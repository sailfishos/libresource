...
#define RESMSG_VIBRA               RESMSG_BIT(4)
#define RESMSG_LEDS                RESMSG_BIT(5)
#define RESMSG_BACKLIGHT           RESMSG_BIT(6)
#define RESMSG_SYSTEM_BUTTON       RESMSG_BIT(8)
#define RESMSG_LOCK_BUTTON         RESMSG_BIT(9)
#define RESMSG_SCALE_BUTTON        RESMSG_BIT(10)
#define RESMSG_SNAP_BUTTON         RESMSG_BIT(11)
#define RESMSG_LENS_COVER          RESMSG_BIT(12)
